...
$select = $naturalbeauty_options['sections-banner-select'];
$slides = $naturalbeauty_options['sections-banner-details'];
$shortcode = $naturalbeauty_options['sections-banner-shortcode'];
$n = 1;
						...
						<div class="container">
							<div class="banner-text">
								...
								<?php if($slide["link_url"] AND $slide["link_title"]) : ?>
									<a class="btn btn-banner rounded-0" href="<?php echo do_shortcode( $slide["link_url"] ) ?>" <?php if ($slide["target"]) echo 'target="_blank"'; ?>><?php echo do_shortcode( $slide["link_title"] )?></a>
								<?php endif; ?>
							</div>
						</div>	
					</div>
