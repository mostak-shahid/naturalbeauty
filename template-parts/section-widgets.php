...
$title = $naturalbeauty_options['sections-widgets-title'];
$content = $naturalbeauty_options['sections-widgets-content'];
$widget_layout = $naturalbeauty_options['sections-widgets-layout'];
