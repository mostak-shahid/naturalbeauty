<?php
    ...
    $opt_name = "naturalbeauty_options";
    ...
    $args['share_icons'][] = array(
        'url'   => 'https://www.facebook.com/naturalbeautybd/',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'mode'     => 'css',
                'theme'    => 'monokai',
                //'desc'     => 'Possible modes can be found at <a href="' . 'http://' . 'ace.c9.io" target="_naturalbeauty">' . 'http://' . 'ace.c9.io/</a>.',
                //'default'  => "body{\n   margin: 0 auto;\n}"
            ),
            array(
                'id'       => 'misc-settings-js',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'misc-page-loader-background',
                'type'     => 'background',                
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                'id'             => 'sections-linking-padding',
                'type'           => 'spacing',
                'mode'           => 'padding',
                'all'            => false,
                'units'          => array( 'em', 'px', '%', 'vw', 'vh' ),
                'units_extended' => 'true',
                'output'         => array( '#section-linking .content-wrap' ),
                'title'          => __( 'Section Padding', 'redux-framework-demo' ),    
                'default'            => array(
                    'padding-top'     => '3.125', 
            ...
            array(
                'id'          => 'sections-linking-slides',
                'type'        => 'mos_slides',
                'title'       => __( 'Section Details', 'redux-framework-demo' ),              
                'show' => array(
                    //'title' => true, //Always true
                    'description' => false,
                    'link_title' => true,
                    'link_url' => false,
                    'target' => false,
                ...
                'placeholder' => array(
                    'title'       => __( 'This is a title', 'redux-framework-demo' ),
                    'link_title'       => __( 'Short Code [link to=""]', 'redux-framework-demo' )
                )
            ),
            array(
                'id'       => 'sections-linking-background',
                'type'     => 'background',                
                'title'    => __( 'Section Background', 'redux-framework-demo' ),
                'output'   => array( '#section-linking' ),
            )
        )
    ) ); 
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array( 
            ...
            array(
                ...
                'default' => '<p>Copyright [copyright-symbol] [this-year] [site-name]· Developed by [theme-credit]</p>'
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            ...
            $sections[] = array(
                ...
                // Leave this as a naturalbeauty section, no options just some intro text set above.
                'fields' => array()
            );
