<?php
//Add theme setup
if ( ! function_exists( 'naturalbeauty_setup' ) ) :
	function naturalbeauty_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'naturalbeauty'),
			'mobilemenu' => __('Mobile Menu', 'naturalbeauty'),
		));
...
add_action( 'after_setup_theme', 'naturalbeauty_setup' );